responses=['Welcome to smart responser','You can suppose me as your assistant','Thanks','Sorry, This is beyond my ability',"Ohh! Sorry, I don't know Your aim but you always take your strict aim in your life because strict aim can change your life."]
...
commands={"JAVA":java,"NAME":myname,"DOST":friendname,"FRIEND":friendname,"BF":boyfriendname,"BOYFRIEND":boyfriendname,"SWEETU":girlfriendname,"JANU":girlfriendname,"JAANU":girlfriendname,"GF":girlfriendname,"GIRLFRIEND":girlfriendname,"END":end,"EXIT":end,"CLOSE":end,"STOP":end,"HELP":help,"AIM":aim,"GOAL":aim,"AMBITION":aim,"MUSIC":music,"PLAY":music}
def main():
    speak(responses[0])
    print(responses[0])
    while True:
